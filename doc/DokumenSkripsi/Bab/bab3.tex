...
\begin{enumerate}
	...
	\begin{itemize}
		\item \textbf{Peta}, merupakan representasi gambar dari data geografi sebuah rute angkutan umum (Gambar \ref{fig:3_tampilan_peta}).
		\begin{figure}[htbp]
			\centering
		...
		\end{figure}
		\item \textbf{\textit{Clear Geodata}}, hapus data geografi pada peta (Gambar \ref{fig:3_tampilan_ubahrute}).
		...
		\item \textbf{Impor Data KML}, menambahkan data geografi pada peta (Gambar \ref{fig:3_tampilan_imporkml}).
		\begin{figure}[htbp]
			\centering
