...
\tanggal{5}{7}{2015}			%hilangkan tanda << & >>
\pembimbing{\PAS/1>>}{<<pembimbing pendamping/2>>}     
...
\judulINA{Porting PHP menjadi Java dan Play Framework. Studi Kasus: KIRI Dashboard Server Side}

\judulENG{Porting PHP to Java and Play Framework. Case Study: KIRI Dashboard Server Side}
