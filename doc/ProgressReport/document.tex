...
\end{itemize}
		...
		\item Melakukan studi literatur tentang MySQL Spatial Extensions, JDBC, Play Framework, JSON, dan \textit{Regular Expression}.\\
		{\bf status :} Ada sejak rencana kerja skripsi, kecuali JDBC, JSON, dan \textit{Regular Expression}\\
		{\bf hasil :}
